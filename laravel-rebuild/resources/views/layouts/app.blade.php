    ...
    <div class="mx-auto flex min-h-screen max-w-content flex-col px-4 tablet:px-gutter">
        ...
        >
            <div class="flex items-center gap-3">
                {{-- Mobiele hamburger — toont/verbergt de sidebar-navigatie via Alpine. --}}
                <button
                    type="button"
                    x-data
                ...
                <a href="{{ url('/') }}" class="text-button-md font-semibold text-ink no-underline">
                    LaVita&nbsp;Urenregistratie
                </a>
            </div>

            {{-- Gebruikersmenu-placeholder. Schermen 6.1/6.8 vullen dit later in. --}}
            <div class="flex items-center gap-3" aria-label="Gebruikersmenu">
                @auth
                    <span class="hidden text-body-sm text-steel tablet:inline">
        ...
        >
            {{-- Hoofdnavigatie. Op mobiel verborgen tot de hamburger 'm openzet. --}}
            <nav
